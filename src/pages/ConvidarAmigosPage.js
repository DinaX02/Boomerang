...
const ConvidarAmigosPage = () => {
  ...
  const shareOnWhatsapp = () => {
    const messageInLink = encodeURIComponent("Recebeste um convite para entrar na Boomerang:");
  ...
  const shareOnTwitter = () => {
    const messageInLink = encodeURIComponent("Junta-te à comunidade Boomerang:");
...
<p className='paraghContainerGreen'>Partilha com os teus amigos e ajuda a fazer crescer a comunidade Boomerang!</p>
<div className='centrarQrCode'>
<QRCode value={qrCodeValue} /></div>
        ...
        <ContainerAddAmigos>
          ...
          <div className='containerShareRedes'>
            ...
            <img src={IconTwitter} alt='icon partilhar Twitter' onClick={shareOnTwitter}/>
            <img src={IconFacebook} alt='icon partilhar facebook' onClick={shareOnFacebook}/>
          </div>
        </ContainerAddAmigos>
